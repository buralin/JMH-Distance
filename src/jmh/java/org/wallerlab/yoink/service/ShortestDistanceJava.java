...
public class ShortestDistanceJava implements ICalculateGridDistance
{	
		...
		{
			return Math.sqrt((in1[0]-in2[0])*(in1[0]-in2[0])+(in1[1]-in2[1])*(in1[1]-in2[1])+(in1[2]-in2[2])*(in1[2]-in2[2]));
	    }
